...
because they were trained on tweets and share this project's preprocessing
conventions: ``<user>`` and ``<url>`` are tokens in that vocabulary, and
:func:`src.utils.preprocessing.preprocess_tweet` emits exactly those.
