...
def main():
    ...
    print(f"Building LSTM (vocab={vocab_size}, embed={EMBED_DIM}, max_len={MAX_LEN})")

    model = build_lstm(vocab_size=vocab_size, max_len=MAX_LEN, embed_dim=EMBED_DIM)
    model.summary()

    ckpt_path = Path(OUT_DIR) / "best.keras"
